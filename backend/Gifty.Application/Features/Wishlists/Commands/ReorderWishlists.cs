...
public record ReorderWishlistsCommand(string UserId, List<ReorderWishlistDto> ReorderedWishlists) : IRequest<Unit>;

public class ReorderWishlistsHandler(IWishlistRepository wishlistRepository)
